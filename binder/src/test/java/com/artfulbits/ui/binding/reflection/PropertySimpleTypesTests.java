...
public class PropertySimpleTypesTests extends TestHolder {
  ...
  public void test_00_Reflection_vs_Access() {
    ...
    final Property<String> fProperty = Models.string("fieldStr");
    final Property<String> sProperty = Models.string("String");
  ...
  public void test_08_Properties_Binding_String() {
    final Property<String> property = Models.string("fieldStr");
  ...
  public void test_11_Properties_Defaults() {
    ...
    final Property<String> propertyString = Models.string("getget", "setset");
