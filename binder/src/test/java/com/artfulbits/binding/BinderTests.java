...
import com.artfulbits.binding.exceptions.ConfigurationError;
import com.artfulbits.binding.toolbox.Listeners;
import com.artfulbits.binding.toolbox.Models;
import com.artfulbits.binding.toolbox.Molds;
...
import static com.artfulbits.binding.toolbox.Models.number;
import static com.artfulbits.binding.toolbox.Models.pojo;
import static com.artfulbits.binding.toolbox.Models.real;
...
public class BinderTests extends TestHolder {
  ...
  public void test_00_PojoToPojo_Simplest() {
    ...
    bss
        .view(pojo(view, Models.text("Login"))) // PojoLoginPassword.getLogin()
        .model(pojo(model, Models.text("Name"))); // PojoNamePin.getName()
  ...
  public void test_01_PojoToPojo_WithFormatting() {
    ...
    bss
        .view(pojo(viewInstance, Models.text("Password"))) // PojoLoginPassword.getPassword()
  ...
  public void test_02_PojoToPojo_WithValidation() {
    ...
    bss
        .view(pojo(viewInstance, Models.text("Name")))
        .model(pojo(modelInstance, Models.text("Login")))
  ...
  public void test_04_Resolve_NoView() {
    ...
    bss
//        .view(pojo(viewInstance, string("Name")))
        .model(pojo(modelInstance, Models.text("Login")))
        .validate(allOf(notNullValue(), containsString("-set")))
        .onSuccess(new Success() {
          @Override
  ...
  public void test_05_Resolve_NoModel() {
    ...
    bss
        .view(pojo(viewInstance, Models.text("Name")))
//        .model(pojo(modelInstance, string("Login")))
        .validate(allOf(notNullValue(), containsString("-set")))
        .onSuccess(new Success() {
          @Override
          public void onValidationSuccess(@Nullable final BindingsManager bm, @NonNull final Binder<?, ?> b) {
  ...
  public void test_06_Resolve_View_BrokenBinding() {
    ...
    bss
        .view(pojo(viewInstance, Models.text("Something")))
        .model(pojo(modelInstance, Models.text("Login")))
        .validate(allOf(notNullValue(), containsString("-set")))
        .onSuccess(new Success() {
          @Override
  ...
  public void test_07_Resolve_Model_BrokenBinding() {
    ...
    bss
        .view(pojo(viewInstance, Models.text("Name")))
        .model(pojo(modelInstance, Models.text("Something")))
        .validate(allOf(notNullValue(), containsString("-set")))
        .onSuccess(new Success() {
          @Override
          public void onValidationSuccess(@NonNull final BindingsManager bm, @NonNull final Binder<?, ?> b) {
  ...
  public void test_10_Listeners() {
    ...
    bss
        .view(pojo(viewInstance, Models.text("Time"))) // viewInstance.getTime(), viewInstance.setTime();
        .model(pojo(modelInstance, number("Timestamp")))
        .onView(Listeners.onObservable())
        .onModel(Listeners.onObservable());
