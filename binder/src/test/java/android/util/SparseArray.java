...
public class SparseArray<E> implements Cloneable {
  ...
  /**
   * Returns an index for which {@link #valueAt} would return the specified key, or a negative number if no keys map to
   * the specified value. Beware that this is a linear search, unlike lookups by key, and that multiple keys can map to
